...
public class StaffController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "All staff members", content = {@Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = Staff.class)))})
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Success - retrieved staff member", content = {@Content(mediaType = "application/json", schema = @Schema(implementation = Staff.class))}),
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "Bad request - staff member was not complete.", content = {@Content(mediaType = "application/json")})
    })
    public ResponseEntity<?> add(@io.swagger.v3.oas.annotations.parameters.RequestBody(description = "The staff member to be added. ID is autogenerated.") @RequestBody final Staff staff){
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Deleted staff", content = {@Content(mediaType = "application/json")}),
            @ApiResponse(responseCode = "404", description = "Not found - staff member to be deleted could not be found", content = {@Content(mediaType = "application/json")})
    })
