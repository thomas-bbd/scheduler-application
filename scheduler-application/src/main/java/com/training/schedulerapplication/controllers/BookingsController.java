...
public class BookingsController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "All bookings", content = {@Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = Booking.class)))})
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Success - retrieved booking", content = {@Content(mediaType = "application/json", schema = @Schema(implementation = Booking.class))}),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Created - added booking", content = {@Content(mediaType = "application/json", schema = @Schema(implementation = Booking.class))}),
            @ApiResponse(responseCode = "400", description = "Bad request", content = {@Content(mediaType = "application/json")})
    })
    public ResponseEntity<?> add(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "A request for adding a booking. ID is autogenerated.")
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Created - added booking", content = {@Content(mediaType = "application/json")}),
            @ApiResponse(responseCode = "404", description = "Not found - either booking, venue, or staff member wasn't found", content = {@Content(mediaType = "application/json")})
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Created - added booking", content = {@Content(mediaType = "application/json")}),
            @ApiResponse(responseCode = "404", description = "Not found - booking to be updated could not be found", content = {@Content(mediaType = "application/json")})
    })
    public ResponseEntity<?> patchUpdate(@Parameter(description = "ID of booking to be updated") @PathVariable Long id,
                                         @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "The new booking details. Don't need to all be populated")
                                         @RequestBody BookingRequest bookingRequest){
        ...
        if (id > 0) {
            ...
            if (validStaffId && validVenueId) {
                ...
                return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Staff/Venue ID invalid. Must be null or greater than 0");
            }
        } else {
